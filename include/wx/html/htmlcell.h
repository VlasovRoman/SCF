...
public:
	...
	bool IsLinebreakAllowed() const wxOVERRIDE
	{
...
public:
	...
	virtual wxHtmlCell* GetFirstChild() const wxOVERRIDE
	{
		return m_Cells;
	}
	...
	virtual bool IsTerminalCell() const wxOVERRIDE
	{
		return false;
	}
	...
	// Call Layout at least once before using GetMaxTotalWidth()
	virtual int GetMaxTotalWidth() const wxOVERRIDE
	{
