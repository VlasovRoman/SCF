...
public:
	...
	*/
	...
	/**
	    Copy constructor.
	*/
	wxRichTextAttr(const wxRichTextAttr& attr): wxTextAttr()
	{
		Copy(attr);
	}
...
public:
	...
	*/
	...
	/**
	    Copy constructor.
	*/
	wxRichTextProperties(const wxRichTextProperties& props): wxObject()
	{
		Copy(props);
	}
...
// Overridables
	...
	*/
	virtual bool CanMerge(wxRichTextObject* WXUNUSED(object), wxRichTextDrawingContext& WXUNUSED(context)) const
	{
		return false;
	}
	...
	*/
	virtual bool Merge(wxRichTextObject* WXUNUSED(object), wxRichTextDrawingContext& WXUNUSED(context))
	{
		return false;
	}
	...
	*/
	virtual bool CanSplit(wxRichTextDrawingContext& WXUNUSED(context)) const
	{
		return false;
	}
	...
	*/
	virtual wxRichTextObject* Split(wxRichTextDrawingContext& WXUNUSED(context))
	{
		return this;
	}
...
// Accessors
	...
	*/
	...
	/**
	    Returns @true if this object is composite.
	*/
	virtual bool IsComposite() const wxOVERRIDE
	{
		return true;
	}
	...
	/**
	    ...
	    @false for most composite objects, but @true for fields, which if composite, should not be user-edited.
	*/
	virtual bool IsAtomic() const wxOVERRIDE
	{
		return false;
	}
...
// Constructors
	...
	wxRichTextParagraphLayoutBox(const wxRichTextParagraphLayoutBox& obj): wxRichTextCompositeObject()
	{
		Init();
		Copy(obj);
	}
...
// Overridables
	...
	virtual wxString GetXMLNodeName() const wxOVERRIDE
	{
...
// Operations
	...
	*/
	...
	virtual wxRichTextObject* Clone() const wxOVERRIDE
	{
...
// Constructors
	...
	*/
	...
	wxRichTextBox(const wxRichTextBox& obj): wxRichTextParagraphLayoutBox()
	{
		Copy(obj);
	}
...
// Constructors
	...
	*/
	...
	wxRichTextField(const wxRichTextField& obj): wxRichTextParagraphLayoutBox()
	{
		Copy(obj);
	}
...
public:
	...
	*/
	...
	/**
	    ...
	    if this is a dynamically changing and/or composite field.
	 */
	virtual bool UpdateField(wxRichTextBuffer* WXUNUSED(buffer), wxRichTextField* WXUNUSED(obj))
	{
		return false;
	}
...
public:
	...
	*/
	virtual bool IsTopLevel(wxRichTextField* WXUNUSED(obj)) const wxOVERRIDE
	{
...
// Constructors
	...
	*/
	...
	wxRichTextParagraph(const wxRichTextParagraph& obj): wxRichTextCompositeObject()
	{
		Copy(obj);
	}
...
// Overridables
	...
	*/
	...
	virtual bool UsesParagraphAttributes() const wxOVERRIDE
	{
		return false;
	}
...
// Constructors
	...
	*/
	...
	/**
	    Copy constructor.
	*/
	wxRichTextImage(const wxRichTextImage& obj): wxRichTextObject(obj)
	{
		Copy(obj);
	}
...
// Overridables
	...
	*/
	...
	virtual bool IsFloatable() const wxOVERRIDE
	{
		return true;
	}
...
// Accessors
	...
	*/
	virtual wxRichTextStyleSheet* GetStyleSheet() const wxOVERRIDE
	{
		return m_styleSheet;
	}
...
// Constructors
	...
	*/
	...
	wxRichTextCell(const wxRichTextCell& obj): wxRichTextBox()
	{
		Copy(obj);
	}
...
// Constructors
	...
	*/
	...
	wxRichTextTable(const wxRichTextTable& obj): wxRichTextBox()
	{
		Copy(obj);
	}
...
// Overridables
	...
	virtual bool HandlesChildSelections() const wxOVERRIDE
	{
		return true;
	}
...
public:
	...
	virtual bool CanSave() const wxOVERRIDE
	{
		return true;
	}

	// Can we load using this handler?
	virtual bool CanLoad() const wxOVERRIDE
	{
		return true;
	}
