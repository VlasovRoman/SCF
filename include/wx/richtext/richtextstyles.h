...
public:
	...
	/// Clones the object
	virtual wxRichTextStyleDefinition* Clone() const wxOVERRIDE
	{
...
public:
	...
	/// Copy constructor
	wxRichTextBoxStyleDefinition(const wxRichTextBoxStyleDefinition& def): wxRichTextStyleDefinition(def)
	{
		Copy(def);
	}
