...
public:
	...
	virtual bool IsListModel() const wxOVERRIDE
	{
		return true;
	}
};
...
public:
	...
	// internal
	virtual bool IsVirtualListModel() const wxOVERRIDE
	{
		return true;
	}
...
public:
	...
	virtual bool SetRowHeight( int WXUNUSED(rowHeight) )
	{
		return false;
	}
