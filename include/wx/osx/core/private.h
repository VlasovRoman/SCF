...
public :
	...
	virtual int         TabHitTest( const wxPoint & WXUNUSED(pt), long *flags )
	{
		*flags=1;
		return -1;
	}
...
public :
	...
	virtual bool SetHint(const wxString& WXUNUSED(hint))
	{
		return false;
	}
...
public :
	...
	virtual wxString GetStringAtIndex(int WXUNUSED(pos)) const
	{
		return wxEmptyString;
	}

	virtual int FindString(const wxString& WXUNUSED(text)) const
	{
		return -1;
	}
};
