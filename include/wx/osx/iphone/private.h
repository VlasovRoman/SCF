...
public :
	...
	bool                EnableTouchEvents(int WXUNUSED(eventsMask))
	{
		return false;
	}
...
public :
	...
	virtual bool EnableMaximizeButton(bool WXUNUSED(enable))
	{
		return false;
	}
	virtual bool EnableMinimizeButton(bool WXUNUSED(enable))
	{
		return false;
	}
