...
struct WXDLLIMPEXP_BASE wxStringData
{
	...
	wxStringCharType* data() const
	{
		return (wxStringCharType*)(this + 1);
	}
...
protected:
	...
	void Init()
	{
		m_pchData = (wxStringCharType *)wxEmptyStringImpl;    // FIXME-UTF8
	}
#else
	void Init()
	{
		m_pchData = (wxStringCharType *)wxEmptyString;
	}
#endif
