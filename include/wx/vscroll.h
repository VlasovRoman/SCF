...
public:
	...
	virtual wxOrientation GetOrientation() const wxOVERRIDE
	{
		return wxVERTICAL;
	}
...
protected:
	...
	wxCoord OnGetUnitSize(size_t n) const wxOVERRIDE
	{
	...
	virtual wxCoord EstimateTotalSize() const wxOVERRIDE
	{
